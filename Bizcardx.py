...
st.markdown(f'<h2> Bizcardx:Extracting Business Card Data with OCR</h2>',
...
if selected=='Home':
    ...
    with col1:
        ...
        st.subheader(":violet[**Technologies Used:**] Python,easy OCR, Streamlit, SQL, Pandas") 
    ...
    with col2:
        ...
        card_pic=Image.open(r"C:\Users\Priyanka\Downloads\biz.png")
        st.image(card_pic,width=400)
    ...
    if image is not None:
        ...
        with col2:
           ...
           #-----------------Extracting city,address,state from card variable---------------------------
            ...
            tab1,tab2,tab3=st.tabs(["Extracted information using easyOCR","Modified Information","Upload to database"])
            with tab1:
                st.write(result)
            with tab2:
...
if selected=="Modify":
    ...
    selected1 = st.selectbox("",("Database","Image data","Update data","Delete data"))
 #---------------------------------------to show database------------------------
